...
const faqItems = [
  ...
  { question: "What are the membership tiers?", answer: "We offer Free, Pro ($19.99/mo), and Elite ($29.99/mo) tiers. Free includes 10 P2P trades/month and basic features. Pro adds unlimited trades, drop alerts, and 3% seller fees. Elite includes everything in Pro plus priority alerts, portfolio analytics, and dedicated support." },
