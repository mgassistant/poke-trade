...
const faqItems = [
  ...
  { question: "What are the membership tiers?", answer: "We offer Free, Pro ($19.99/mo), and Elite ($29.99/mo) tiers. Free includes 10 P2P trades/month, daily drop alert digests, and basic features. Pro adds unlimited trades, real-time restock & drop alerts across 8 retailers, and 3% seller fees. Elite includes everything in Pro plus priority alerts (30s faster), portfolio analytics, and dedicated support." },
  ...
  { question: "What are drop alerts?", answer: "Drop alerts notify you when new or limited-edition Pokémon products drop at major retailers. All members get alerts — Free members receive a daily digest, Pro members get real-time notifications, and Elite members get priority alerts 30 seconds faster than everyone else. We monitor 8 major retailers including Target, Walmart, Amazon, and Pokémon Center." },
