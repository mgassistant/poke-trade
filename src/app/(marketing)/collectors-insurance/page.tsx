...
const roadmapItems = [
  { icon: Shield, label: "Collector Insurance", active: true },
  { icon: Store, label: "Card Shop Insurance", active: false },
  { icon: ShieldCheck, label: "Marketplace Seller Insurance", active: false },
  { icon: Users, label: "Convention Vendor", active: false },
  { icon: Truck, label: "Shipping Insurance", active: false },
  ...
  { icon: Building2, label: "Business Insurance", active: false },
...
export default function CollectorsInsurancePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/insurance/collector-lead", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          current_insurance: formData.current_insurance || null,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-blue-100/80 max-w-3xl mx-auto leading-relaxed">
            Get connected with licensed insurance partners offering coverage options designed for
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">
              ...
              <span className="text-blue-600">Designed to Make Insurance Easier.</span>
            </h2>
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              Your verified Poké-Trade portfolio documents everything insurance partners need.
            </p>
          </div>
          ...
          <div className="mt-10 bg-blue-50 border border-blue-100 rounded-xl p-4 text-center">
            <p className="text-sm text-blue-700">
              ...
              documentation to participating insurance partners. Final valuation, underwriting
              decisions, and coverage remain the responsibility of the licensed insurance provider.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-500 mb-6">Get started with insurance quotes</p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-gray-700">
                  <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
                  Access to insurance quote requests
                </li>
                <li className="flex items-start gap-2 text-sm text-gray-700">
                  <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
          ...
          <div className="mt-8 bg-gray-50 border border-gray-200 rounded-xl p-4 text-center">
            <p className="text-xs text-gray-500">
              Member benefits, pricing, discounts, and offers vary by participating insurance
      ...
      <section className="py-20 sm:py-28 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              A verified Poké-Trade portfolio gives insurance partners the organized documentation they need.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden mb-12">
            <div className="bg-gradient-to-r from-[#0f2044] to-[#1a3a6a] p-6">
              ...
              <p className="text-blue-200 text-sm">Insurance-ready documentation</p>
            </div>
            <div className="p-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { icon: FileText, label: "Insurance Summary Report", desc: "Pre-formatted for insurers" },
      ...
      {/* Homeowners vs Collectibles Insurance */}
      <section className="py-20 sm:py-28 bg-gray-50">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Homeowners Insurance</h3>
            ...
            <div className="bg-gradient-to-b from-blue-50 to-white rounded-2xl border-2 border-blue-300 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Collectibles Insurance</h3>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4 text-center">
            <p className="text-sm text-blue-700">
              Coverage varies by insurer and policy. Consult with a licensed insurance professional
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-500">
              Fill out the form below and a licensed insurance specialist will contact you
          ...
          {submitted ? (
            <div className="bg-green-50 border border-green-200 rounded-2xl p-12 text-center">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                A licensed insurance specialist will review your information and contact you within
                ...
                {formData.has_portfolio && (
                  <label className="flex items-start gap-3 bg-white rounded-lg border border-blue-200 p-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">
                      I consent to share my verified portfolio summary with participating insurance
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, current_insurance: e.target.value })
                    }
                    className="w-full h-11 rounded-lg border border-gray-300 px-4 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none bg-white transition-colors"
                  >
      ...
      <section className="py-20 sm:py-28 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              We&apos;re building the most comprehensive insurance marketplace for the collectibles industry.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 py-6">
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              ...
              licensed insurance agency, insurance broker, or insurance carrier. Insurance products
              are offered exclusively through licensed third-party insurance agencies, brokers, or
              insurance companies. Coverage availability, premiums, discounts, eligibility, limits,
