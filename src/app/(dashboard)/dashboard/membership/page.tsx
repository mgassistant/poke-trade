...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Trade Protection: Up to $50 discretionary platform credit per protected trade", included: true, highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Priority support", included: true, highlight: false },
      { text: "Trade Protection: Up to $100 discretionary platform credit per protected trade", included: true, highlight: true },
      { text: "Priority listings", included: true, highlight: false },
      { text: "Advanced analytics", included: true, highlight: false },
